(function () {
  ...
  function applyFullscreenForPane(pane) {
    document.body.classList.toggle('mermaid-fullscreen', pane !== 'code');
  }
  ...
  function enter() {
    ...
    if (boundId) {
      state.boundNoteId = boundId;
      lsSet(LS_NOTE_ID, boundId);
      const n = noteById(boundId);
      const ta = $('mermaid-code');
