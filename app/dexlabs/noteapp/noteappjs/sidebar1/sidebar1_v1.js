...
function injectSidebarStyles() {
  ...
  // CSS has been extracted to sidebar1-8.css — load it once via a <link> tag.
  // Adjust the href path to match your deployment structure.
  const link = document.createElement("link");
  link.id   = "dexSidebarStyles";
  link.rel  = "stylesheet";
  link.href = "sidebar1-8.css";
