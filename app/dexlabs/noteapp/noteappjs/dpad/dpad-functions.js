/* ================================================================
   dpad-functions.js
   -----------------------------------------------------------------
   Direction & drag behavior for the D-Pad:
     • Single-step: up / down / left / right
     • Fast-step (×10): double up / double down / double left / double right
     • Long-press auto-repeat with acceleration
     • Center-dragger joystick (touch + pointer pathways)
   Reads DOM refs and shared state from window.__dexDpad, which is
   populated by dpad-layout.js — this file MUST be loaded after it.
   ================================================================ */
...
(function () {
  ...
  /* ====== LONG-PRESS AUTO-REPEAT ======
     Single tap → one move. Press-and-hold → after HOLD_START_DELAY, keeps
     moving on an accelerating interval until pointer is released. */
  ...
  // Mirror on document so a finger sliding off the small circle still counts.
  ...
  /* Expose the joystick starters in case other modules need them */
