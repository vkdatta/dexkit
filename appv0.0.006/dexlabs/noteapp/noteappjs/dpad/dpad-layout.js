if (window.__dexToolbar2Loaded) {
  ...
  (function watchSidebarVisibility() {
    ...
    const mo = new MutationObserver(onSidebarChange);
    if (sb1) mo.observe(sb1, { attributes: true, attributeFilter: ['class'] });
    if (sb2) mo.observe(sb2, { attributes: true, attributeFilter: ['class'] });
  })();
